...
namespace QtStackedBar3DVis
{
	...
	QCustomRenderItem3D::QCustomRenderItem3D()
	...
	void QCustomRenderItem3D::setMesh(const QString &meshFile)
	{
		QObjectHelper3D::resetObjectHelper(m_renderer, m_object, meshFile);
	}

	void QCustomRenderItem3D::setColorTable(const QVector<QRgb> &colors)
	{
	...
	void QCustomRenderItem3D::setMinBounds(const QVector3D &bounds)
	{
		m_minBounds = bounds;
	...
	void QCustomRenderItem3D::setMaxBounds(const QVector3D &bounds)
	{
		m_maxBounds = bounds;
	...
	void QCustomRenderItem3D::setSliceFrameColor(const QColor &color)
	{
