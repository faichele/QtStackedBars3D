...
#ifndef Q_CUSTOM_VOLUME_3D_H
#define Q_CUSTOM_VOLUME_3D_H
...
namespace QtStackedBar3DVis
{
	...
	class QCustomVolume3DPrivate;

	class QT_STACKEDBAR3D_EXPORT QCustomVolume3D : public QCustomItem3D
	{
		Q_OBJECT
	...
	public:
		...
		explicit QCustomVolume3D(QObject *parent = Q_NULLPTR);
		explicit QCustomVolume3D(const QVector3D &position, const QVector3D &scaling,
	...
	protected:
		QCustomVolume3DPrivate *dptr();
		const QCustomVolume3DPrivate *dptrc() const;

	private:
		Q_DISABLE_COPY(QCustomVolume3D)
