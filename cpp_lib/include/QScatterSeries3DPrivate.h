...
namespace QtStackedBar3DVis
{
	...
	class QScatterSeries3DPrivate : public QAbstractSeries3DPrivate
	{
		Q_OBJECT
	public:
		QScatterSeries3DPrivate(QScatterSeries3D *q);
		virtual ~QScatterSeries3DPrivate();
	...
	private:
		QScatterSeries3D *qptr();
		int m_selectedItem;
		float m_itemSize;

	private:
		friend class QScatterSeries3D;
	};
