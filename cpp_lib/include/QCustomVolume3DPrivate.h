...
#ifndef Q_CUSTOM_VOLUME_3D_PRIVATE_H
#define Q_CUSTOM_VOLUME_3D_PRIVATE_H
...
namespace QtStackedBar3DVis
{
	...
	class QCustomVolume3DPrivate : public QCustomItem3DPrivate
	{
		Q_OBJECT

	public:
		QCustomVolume3DPrivate(QCustomVolume3D *q);
		QCustomVolume3DPrivate(QCustomVolume3D *q, const QVector3D &position, const QVector3D &scaling,
		...
		virtual ~QCustomVolume3DPrivate();

		void resetDirtyBits();
		QImage renderSlice(Qt::Axis axis, int index);

		QCustomVolume3D *qptr();
