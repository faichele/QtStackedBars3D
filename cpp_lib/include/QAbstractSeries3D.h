...
#ifndef Q_ABSTRACT_3D_SERIES_H
#define Q_ABSTRACT_3D_SERIES_H
...
namespace QtStackedBar3DVis
{
	...
	class QAbstractSeries3DPrivate;

	class QT_STACKEDBAR3D_EXPORT QAbstractSeries3D : public QObject
	{
		Q_OBJECT
			Q_ENUMS(SeriesType)
			Q_ENUMS(Mesh)
			...
			Q_PROPERTY(QTheme3D::ColorStyle colorStyle READ colorStyle WRITE setColorStyle NOTIFY colorStyleChanged)
	...
	protected:
		explicit QAbstractSeries3D(QAbstractSeries3DPrivate *d, QObject *parent = Q_NULLPTR);

	public:
		virtual ~QAbstractSeries3D();
		...
		QTheme3D::ColorStyle colorStyle() const;
	...
	protected:
		QScopedPointer<QAbstractSeries3DPrivate> d_ptr;

	private:
		Q_DISABLE_COPY(QAbstractSeries3D)
		...
		friend class QSeriesRenderCache3D;
		friend class QStackedBarSeriesRenderCache3D;
