...
#ifndef Q_ABSTRACT_SERIES_3D_H
#define Q_ABSTRACT_SERIES_3D_H
...
namespace QtStackedBar3DVis
{
	...
	struct QAbstractSeriesChangeBitField3D {
		bool meshChanged : 1;
		...
		QAbstractSeriesChangeBitField3D()
			: meshChanged(true),
	...
	class QAbstractSeries3DPrivate : public QObject
	{
		Q_OBJECT
	public:
		QAbstractSeries3DPrivate(QAbstractSeries3D *q, QAbstractSeries3D::SeriesType type);
		virtual ~QAbstractSeries3DPrivate();

		QAbstractDataProxy3D *dataProxy() const;
		virtual void setDataProxy(QAbstractDataProxy3D *proxy);
		virtual void setController(QAbstractController3D *controller);
		virtual void connectControllerAndProxy(QAbstractController3D *newController) = 0;
		virtual void createItemLabel() = 0;

		void setItemLabelFormat(const QString &format);
		void setVisible(bool visible);
		void setMesh(QAbstractSeries3D::Mesh mesh);
		void setMeshSmooth(bool enable);
		void setMeshRotation(const QQuaternion &rotation);
		void setUserDefinedMesh(const QString &meshFile);

		void setColorStyle(QTheme3D::ColorStyle style);
		...
		void resetToTheme(const QTheme3D &theme, int seriesIndex, bool force);
		QString itemLabel();
		void markItemLabelDirty();
		inline bool itemLabelDirty() const { return m_itemLabelDirty; }
		void setItemLabelVisible(bool visible);

		QAbstractSeriesChangeBitField3D m_changeTracker;
		QAbstract3DSeriesThemeOverrideBitField m_themeTracker;
		QAbstractSeries3D *q_ptr;
		QAbstractSeries3D::SeriesType m_type;
		QString m_itemLabelFormat;
		QAbstractDataProxy3D *m_dataProxy;
		bool m_visible;
