...
#ifndef Q_ABSTRACT_AXIS_3D_H
#define Q_ABSTRACT_AXIS_3D_H
...
{
	class QAbstractAxis3DPrivate;

	class QT_STACKEDBAR3D_EXPORT QAbstractAxis3D : public QObject
	{
		Q_OBJECT
	...
	protected:
		explicit QAbstractAxis3D(QAbstractAxis3DPrivate *d, QObject *parent = Q_NULLPTR);

	public:
		virtual ~QAbstractAxis3D();
	...
	Q_SIGNALS:
		...
		void labelsChanged();
		void orientationChanged(QAbstractAxis3D::AxisOrientation orientation);
	...
	protected:
		QScopedPointer<QAbstractAxis3DPrivate> d_ptr;

	private:
		Q_DISABLE_COPY(QAbstractAxis3D)
