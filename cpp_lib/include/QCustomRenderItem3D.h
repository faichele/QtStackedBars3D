...
#ifndef Q_CUSTOM_RENDER_ITEM_H
#define Q_CUSTOM_RENDER_ITEM_H
...
namespace QtStackedBar3DVis
{
	...
	class QT_STACKEDBAR3D_EXPORT QCustomRenderItem3D : public QAbstractRenderItem3D
	{
	public:
		QCustomRenderItem3D();
		virtual ~QCustomRenderItem3D();

		inline void setTexture(GLuint texture) { m_texture = texture; }
		inline GLuint texture() const { return m_texture; }
		void setMesh(const QString &meshFile);
		inline QObjectHelper3D *mesh() const { return m_object; }
		...
		inline void setItemPointer(QCustomItem3D *item) { m_item = item; }
		inline QCustomItem3D *itemPointer() const { return m_item; }
		...
		inline void setRenderer(QAbstractRenderer3D *renderer) { m_renderer = renderer; }
	...
	private:
		Q_DISABLE_COPY(QCustomRenderItem3D)
	...
	typedef QHash<QCustomItem3D *, QCustomRenderItem3D *> CustomRenderItemArray;
}
