...
namespace QtStackedBar3DVis
{
	...
	class QT_STACKEDBAR3D_EXPORT QBarRenderItem3D : public QAbstractRenderItem3D
	{
	public:
		QBarRenderItem3D();
		QBarRenderItem3D(const QBarRenderItem3D &other);
		virtual ~QBarRenderItem3D();
	...
	class BarRenderSliceItem : public QBarRenderItem3D
	{
	public:
		BarRenderSliceItem();
		...
		void setItem(const QBarRenderItem3D &renderItem);
	...
	typedef QVector<QBarRenderItem3D> BarRenderItemRow3D;
	typedef QVector<BarRenderItemRow3D> BarRenderItemArray;
