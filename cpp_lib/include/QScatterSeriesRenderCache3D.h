...
namespace QtStackedBar3DVis
{
	...
	class QScatterObjectBufferHelper3D;
	class QScatterPointBufferHelper3D;

	class QScatterSeriesRenderCache3D : public QSeriesRenderCache3D
	{
	public:
		QScatterSeriesRenderCache3D(QAbstractSeries3D *series, QAbstractRenderer3D *renderer);
		virtual ~QScatterSeriesRenderCache3D();

		void cleanup(QTextureHelper3D *texHelper);

		inline QScatterRenderItemArray3D &renderArray() { return m_renderArray; }
		inline QScatterSeries3D *series() const { return static_cast<QScatterSeries3D *>(m_series); }
		...
		inline void setBufferObject(QScatterObjectBufferHelper3D *object) { m_scatterBufferObj = object; }
		inline QScatterObjectBufferHelper3D *bufferObject() const { return m_scatterBufferObj; }
		inline void setBufferPoints(QScatterPointBufferHelper3D *object) { m_scatterBufferPoints = object; }
		inline QScatterPointBufferHelper3D *bufferPoints() const { return m_scatterBufferPoints; }
	...
	protected:
		QScatterRenderItemArray3D m_renderArray;
		float m_itemSize;
		...
		QScatterObjectBufferHelper3D *m_scatterBufferObj;
		QScatterPointBufferHelper3D *m_scatterBufferPoints;
