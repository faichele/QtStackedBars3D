...
#ifndef Q_CATEGORY_AXIS_3D_PRIVATE_H
#define Q_CATEGORY_AXIS_3D_PRIVATE_H
...
namespace QtStackedBar3DVis
{
	...
	class QCategoryAxis3DPrivate : public QAbstractAxis3DPrivate
	{
		Q_OBJECT

	public:
		QCategoryAxis3DPrivate(QCategoryAxis3D *q);
		virtual ~QCategoryAxis3DPrivate();
