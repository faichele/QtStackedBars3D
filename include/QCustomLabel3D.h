...
#ifndef Q_CUSTOM_LABEL_ITEM_3D_H
#define Q_CUSTOM_LABEL_ITEM_3D_H
...
namespace QtStackedBar3DVis
{
	...
	class QCustomLabel3DPrivate;

	class QT_STACKEDBAR3D_EXPORT QCustomLabel3D : public QCustomItem3D
	{
		Q_OBJECT
	...
	public:
		explicit QCustomLabel3D(QObject *parent = Q_NULLPTR);
		explicit QCustomLabel3D(const QString &text, const QFont &font, const QVector3D &position,
	...
	protected:
		QCustomLabel3DPrivate *dptr();
		const QCustomLabel3DPrivate *dptrc() const;

	private:
		Q_DISABLE_COPY(QCustomLabel3D)
