...
#ifndef Q_CUSTOM_ITEM_3D_PRIVATE_H
#define Q_CUSTOM_ITEM_3D_PRIVATE_H
...
namespace QtStackedBar3DVis
{
	...
	class QCustomItem3DPrivate : public QObject
	{
		Q_OBJECT
	public:
		QCustomItem3DPrivate(QCustomItem3D *q);
		QCustomItem3DPrivate(QCustomItem3D *q, const QString &meshFile, const QVector3D &position,
			const QVector3D &scaling, const QQuaternion &rotation);
		virtual ~QCustomItem3DPrivate();
	...
	private:
		QCustomItem3DPrivate(QCustomItem3DPrivate *d);

		friend class QCustomItem3D;
	};
