...
#ifndef Q_VALUE_AXIS_3D_PRIVATE_H
#define Q_VALUE_AXIS_3D_PRIVATE_H
...
namespace QtStackedBar3DVis
{
	...
	class QValueAxis3DPrivate : public QAbstractAxis3DPrivate
	{
		Q_OBJECT

	public:
		QValueAxis3DPrivate(QValueAxis3D *q);
		virtual ~QValueAxis3DPrivate();
