...
namespace QtStackedBar3DVis
{
	...
	class QT_STACKEDBAR3D_EXPORT QScatterPointBufferHelper3D : public QAbstractObjectHelper3D
	{
	public:
		QScatterPointBufferHelper3D();
		virtual ~QScatterPointBufferHelper3D();

		GLuint pointBuf();

		void pushPoint(uint pointIndex);
		void popPoint();
		void load(QScatterSeriesRenderCache3D *cache);
		void update(QScatterSeriesRenderCache3D *cache);
	...
	private:
		void createRangeGradientUVs(QScatterSeriesRenderCache3D *cache,
