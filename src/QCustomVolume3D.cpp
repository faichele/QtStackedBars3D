...
namespace QtStackedBar3DVis
{
	...
	/*!
	* \class QCustomVolume3D
	* \inmodule QtDataVisualization
	* \brief The QCustomVolume3D class adds a volume rendered object to a graph.
	...
	*
	* \sa QAbstractGraph3D::addCustomItem(), QAbstractGraph3D::orthoProjection, useHighDefShader
	*/
	...
	* Defaults to \c{-1}.
	*
	* \sa QCustomVolume3D::textureData, drawSlices, drawSliceFrames
	*/
	...
	*/
	QCustomVolume3D::QCustomVolume3D(QObject *parent) :
		QCustomItem3D(new QCustomVolume3DPrivate(this), parent)
	{
	}
	...
	*/
	QCustomVolume3D::QCustomVolume3D(const QVector3D &position, const QVector3D &scaling,
		...
		QCustomItem3D(new QCustomVolume3DPrivate(this, position, scaling, rotation, textureWidth,
	...
	*/
	QCustomVolume3D::~QCustomVolume3D()
	{
	}

	/*! \property QCustomVolume3D::textureWidth
	*
	...
	*/
	void QCustomVolume3D::setTextureWidth(int value)
	{
		if (value >= 0) {
	...
	int QCustomVolume3D::textureWidth() const
	{
		return dptrc()->m_textureWidth;
	}

	/*! \property QCustomVolume3D::textureHeight
	*
	...
	*/
	void QCustomVolume3D::setTextureHeight(int value)
	{
		if (value >= 0) {
	...
	int QCustomVolume3D::textureHeight() const
	{
		return dptrc()->m_textureHeight;
	}

	/*! \property QCustomVolume3D::textureDepth
	*
	...
	*/
	void QCustomVolume3D::setTextureDepth(int value)
	{
		if (value >= 0) {
	...
	int QCustomVolume3D::textureDepth() const
	{
	...
	* \sa textureData
	*/
	void QCustomVolume3D::setTextureDimensions(int width, int height, int depth)
	{
	...
	*/
	int QCustomVolume3D::textureDataWidth() const
	{
	...
	/*! \property QCustomVolume3D::sliceIndexX
	*
	...
	*/
	void QCustomVolume3D::setSliceIndexX(int value)
	{
	...
	int QCustomVolume3D::sliceIndexX() const
	{
		return dptrc()->m_sliceIndexX;
	}

	/*! \property QCustomVolume3D::sliceIndexY
	*
	...
	* \sa textureData, drawSlices, drawSliceFrames
	*/
	void QCustomVolume3D::setSliceIndexY(int value)
	{
	...
	int QCustomVolume3D::sliceIndexY() const
	{
		return dptrc()->m_sliceIndexY;
	}

	/*! \property QCustomVolume3D::sliceIndexZ
	*
	...
	* \sa textureData, drawSlices, drawSliceFrames
	*/
	void QCustomVolume3D::setSliceIndexZ(int value)
	{
	...
	int QCustomVolume3D::sliceIndexZ() const
	{
	...
	* \sa textureData
	*/
	void QCustomVolume3D::setSliceIndices(int x, int y, int z)
	{
		setSliceIndexX(x);
		setSliceIndexY(y);
		setSliceIndexZ(z);
	...
	/*! \property QCustomVolume3D::colorTable
	*
	...
	*/
	void QCustomVolume3D::setColorTable(const QVector<QRgb> &colors)
	{
	...
	QVector<QRgb> QCustomVolume3D::colorTable() const
	{
		return dptrc()->m_colorTable;
	}

	/*! \property QCustomVolume3D::textureData
	*
	...
	*
	* Ownership of the new array transfers to the QCustomVolume3D instance.
	...
	*/
	void QCustomVolume3D::setTextureData(QVector<uchar> *data)
	{
	...
	*/
	QVector<uchar> *QCustomVolume3D::createTextureData(const QVector<QImage *> &images)
	{
	...
	QVector<uchar> *QCustomVolume3D::textureData() const
	{
	...
	*/
	void QCustomVolume3D::setSubTextureData(Qt::Axis axis, int index, const uchar *data)
	{
		if (data) {
	...
	* \sa textureData, renderSlice()
	*/
	void QCustomVolume3D::setSubTextureData(Qt::Axis axis, int index, const QImage &image)
	{
	...
	*/
	void QCustomVolume3D::setTextureFormat(QImage::Format format)
	{
	...
	* \sa setTextureFormat()
	*/
	QImage::Format QCustomVolume3D::textureFormat() const
	{
		return dptrc()->m_textureFormat;
	}

	/*!
	* \fn void QCustomVolume3D::textureFormatChanged(QImage::Format format)
	*
	...
	*/
	...
	/*!
	* \property QCustomVolume3D::alphaMultiplier
	*
	...
	*/
	void QCustomVolume3D::setAlphaMultiplier(float mult)
	{
		if (mult >= 0.0f) {
	...
	float QCustomVolume3D::alphaMultiplier() const
	{
		return dptrc()->m_alphaMultiplier;
	}

	/*!
	* \property QCustomVolume3D::preserveOpacity
	*
	...
	* \sa alphaMultiplier
	*/
	void QCustomVolume3D::setPreserveOpacity(bool enable)
	{
	...
	bool QCustomVolume3D::preserveOpacity() const
	{
		return dptrc()->m_preserveOpacity;
	}

	/*!
	* \property QCustomVolume3D::useHighDefShader
	*
	...
	* \sa renderSlice()
	*/
	void QCustomVolume3D::setUseHighDefShader(bool enable)
	{
	...
	bool QCustomVolume3D::useHighDefShader() const
	{
		return dptrc()->m_useHighDefShader;
	}

	/*!
	* \property QCustomVolume3D::drawSlices
	*
	...
	* \sa sliceIndexX, sliceIndexY, sliceIndexZ
	*/
	void QCustomVolume3D::setDrawSlices(bool enable)
	{
	...
	bool QCustomVolume3D::drawSlices() const
	{
		return dptrc()->m_drawSlices;
	}

	/*!
	* \property QCustomVolume3D::drawSliceFrames
	*
	...
	*/
	void QCustomVolume3D::setDrawSliceFrames(bool enable)
	{
	...
	bool QCustomVolume3D::drawSliceFrames() const
	{
		return dptrc()->m_drawSliceFrames;
	}

	/*!
	* \property QCustomVolume3D::sliceFrameColor
	*
	...
	* \sa drawSliceFrames
	*/
	void QCustomVolume3D::setSliceFrameColor(const QColor &color)
	{
	...
	QColor QCustomVolume3D::sliceFrameColor() const
	{
		return dptrc()->m_sliceFrameColor;
	}

	/*!
	* \property QCustomVolume3D::sliceFrameWidths
	*
	...
	* \sa drawSliceFrames
	*/
	void QCustomVolume3D::setSliceFrameWidths(const QVector3D &values)
	{
	...
	QVector3D QCustomVolume3D::sliceFrameWidths() const
	{
		return dptrc()->m_sliceFrameWidths;
	}

	/*!
	* \property QCustomVolume3D::sliceFrameGaps
	*
	...
	* \sa drawSliceFrames
	*/
	void QCustomVolume3D::setSliceFrameGaps(const QVector3D &values)
	{
		if (values.x() < 0.0f || values.y() < 0.0f || values.z() < 0.0f) {
			qWarning() << __FUNCTION__ << "Attempted to set negative values.";
		}
	...
	QVector3D QCustomVolume3D::sliceFrameGaps() const
	{
		return dptrc()->m_sliceFrameGaps;
	}

	/*!
	* \property QCustomVolume3D::sliceFrameThicknesses
	*
	...
	* \sa drawSliceFrames
	*/
	void QCustomVolume3D::setSliceFrameThicknesses(const QVector3D &values)
	{
		if (values.x() < 0.0f || values.y() < 0.0f || values.z() < 0.0f) {
			qWarning() << __FUNCTION__ << "Attempted to set negative values.";
		}
	...
	QVector3D QCustomVolume3D::sliceFrameThicknesses() const
	{
	...
	* \sa setTextureFormat()
	*/
	QImage QCustomVolume3D::renderSlice(Qt::Axis axis, int index)
	{
	...
	* \internal
	*/
	QCustomVolume3DPrivate *QCustomVolume3D::dptr()
	{
		return static_cast<QCustomVolume3DPrivate *>(d_ptr.data());
	}

	/*!
	* \internal
	*/
	const QCustomVolume3DPrivate *QCustomVolume3D::dptrc() const
	{
		return static_cast<const QCustomVolume3DPrivate *>(d_ptr.data());
	}

	QCustomVolume3DPrivate::QCustomVolume3DPrivate(QCustomVolume3D *q) :
	...
	QCustomVolume3DPrivate::QCustomVolume3DPrivate(QCustomVolume3D *q, const QVector3D &position,
		...
		QCustomItem3DPrivate(q, QStringLiteral(":/defaultMeshes/barFull"), position, scaling, rotation),
	...
	QCustomVolume3DPrivate::~QCustomVolume3DPrivate()
	{
		delete m_textureData;
	}

	void QCustomVolume3DPrivate::resetDirtyBits()
	{
	...
	QImage QCustomVolume3DPrivate::renderSlice(Qt::Axis axis, int index)
	{
		if (index < 0)
			return QImage();
	...
	int QCustomVolume3DPrivate::multipliedAlphaValue(int alpha)
	{
	...
	QCustomVolume3D *QCustomVolume3DPrivate::qptr()
	{
		return static_cast<QCustomVolume3D *>(q_ptr);
	}
